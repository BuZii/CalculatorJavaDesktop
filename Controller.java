...
public class Controller {
    ...
    void initialize() {
        ...
        equal_btn.setOnAction(event -> {
            if(this.operaton == '+' || this.operaton == '-' || this.operaton == '/'
                    || this.operaton == '*')
                equalMethod();
        });
    ...
    void equalMethod()
    {
        ...
        int temp = 1000000;
        if (res == temp)
            lable_field.setText("BuZi");
        else
            lable_field.setText(String.valueOf(res));
